...
@onready var skeleton_3d: MeshInstance3D = $skeleton_mage/Rig/Skeleton3D/Skeleton_Mage_ArmLeft
...
func _physics_process(delta: float) -> void:
	...
	if skeleton_3d and direction.length_squared() > 0.001:
		var look_dir := Vector3(-direction.x, 0.0, -direction.y).normalized()
		skeleton_3d.look_at(skeleton_3d.global_position + look_dir, Vector3.UP)
